...
export class ServiceCenterComponent {
  ...
  /**
   * get List of serviceCollectionCenter
   */
  getList() {
    ...
    this.TransactionHistoryService.GetServiceCenterCollection(
      this.searchText,
      this.sort,
      this.pageNo,
      this.customerSearch,
      ...
      if (response) {
        this.serviceCollectionCenter = response?.data;
        console.log(
          this.serviceCollectionCenter,
          'this.serviceCollectionCenter'
        );
        ...
        this.serviceCollectionCenter.forEach((x) => {
